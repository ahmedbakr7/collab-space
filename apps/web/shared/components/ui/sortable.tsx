...
function SortableContent(props: SortableContentProps) {
  ...
  const renderedElement = useRender({
    render: render || <div />,
    props: { ...contentProps, 'data-slot': 'sortable-content', children },
  });
...
function SortableItem(props: SortableItemProps) {
  const { value, style, asHandle, render, disabled, className, ...itemProps } =
    props;
  ...
  const composedRef = useComposedRefs(props.ref, (node: HTMLElement | null) => {
    if (disabled) return;
    setNodeRef(node);
  ...
  const ItemElement = render ? renderedElement : <div {...renderProps} />;
...
function SortableItemHandle(props: SortableItemHandleProps) {
  ...
  return render ? renderedElement : <button {...handleProps} />;
}

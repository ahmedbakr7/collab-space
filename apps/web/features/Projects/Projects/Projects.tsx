...
const mockColumns = [
    {
        ...
        tasks: [
            ...
            },
            {
                ...
                description:
                    "Add documentation for the new authentication endpoints",
                assignee: {
                    name: "Michael Chen",
        ...
        tasks: [
            {
                ...
                description:
                    "Redesigned profile page with new layout and features",
                assignee: {
...
function ProjectsGrid() {
    return (
        <div className="flex-1 flex flex-row gap-3 p-3 overflow-scroll"></div>
    );
}

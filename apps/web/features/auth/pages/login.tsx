            ...
            <div className="bg-primary hidden lg:flex flex-col justify-between p-12 pt-36 lg:w-1/2 h-full text-background">
                <div className="flex flex-col gap-5">
                    <div className="flex flex-row items-center">
                        <div className="mr-3 w-12 h-12 rounded-xl bg-white/20 backdrop-blur-sm flex justify-center items-center">
                    ...
                    <p>
                        The modern workspace for teams to organize projects,
                        manage tasks, and collaborate in real-time.
                    </p>
                </div>
                <div>
